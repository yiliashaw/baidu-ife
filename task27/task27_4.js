...
function Adapter(spaceship) {
  ...
  return {
    encode: function(id, cmd) {
      switch (cmd) {
        case "fly":
          signal = ("0000" + id.toString(2)).slice(-4) + "0001";
          break;
        case "stop":
          signal = ("0000" + id.toString(2)).slice(-4) + "0010";
          break;
        case "destroy":
          signal = ("0000" + id.toString(2)).slice(-4) + "1100";
          break;
        default:
